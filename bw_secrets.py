...
EMBEDDING_MODEL = client.secrets().get(
    "acdc7908-34c5-4975-a91c-b3230129f62f").data.value
SUMMARY_MODEL = client.secrets().get(
    "ee253199-3cfc-484a-83d2-b323012587c7").data.value
